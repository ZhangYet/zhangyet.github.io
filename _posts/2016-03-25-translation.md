...
P407 蓝线 在某些不太关心 一句 改为 在某些不太重要的使用场合，我们可以使用它提供的函数客服两个系统内部的不兼容，以一致的方式整合两个系统的输出。

P407 蓝线 一些能力并不比适用于传统绘图系统 改为 一些功能并不适用于传统绘图系统

P407 蓝线 然而，经常需要使用传统绘图系统 改为 然而，我们还是常常需要传统绘图系统